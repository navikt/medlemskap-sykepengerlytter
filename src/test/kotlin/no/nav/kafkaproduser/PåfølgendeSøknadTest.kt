...
class PåfølgendeSøknadTest {
    ...
    fun `JsonObjektInneholderFomTom`(){
        val json = JacksonParser().parseMedlemskap(Medlemskap("12343", LocalDate.now(), LocalDate.now(),Status.JA))
        println(json)
    }
    ...
    fun `test påfølgende logikk`(){
        ...
        val sokndA = Medlemskap("1234", LocalDate.of(2022,1,1), LocalDate.of(2022,1,10),Status.JA)
        val sokndB = Medlemskap("1234", LocalDate.of(2022,1,11), LocalDate.of(2022,1,20),Status.JA)
        println(sokndA)
        println(sokndB)
    ...
    fun `test påfølgende logikk med medlemskap som starter midt i perioden`(){
        ...
        val sokndA = Medlemskap("1234", LocalDate.of(2022,1,1), LocalDate.of(2022,1,10),Status.JA)
        val sokndB = Medlemskap("1234", LocalDate.of(2022,1,7), LocalDate.of(2022,1,20),Status.JA)
        println(sokndA)
        println(sokndB)
        Assertions.assertTrue(sokndB.erpåfølgende(sokndA))
    ...
    fun `test påfølgende logikk med medlemskap som en dag for sent`(){
        ...
        val sokndA = Medlemskap("1234", LocalDate.of(2022,1,1), LocalDate.of(2022,1,10),Status.JA)
        val sokndB = Medlemskap("1234", LocalDate.of(2022,1,12), LocalDate.of(2022,1,20),Status.JA)
        println(sokndA)
        println(sokndB)
    ...
    fun `test påfølgende logikk med medlemskap som er før`(){
        ...
        val sokndA = Medlemskap("1234", LocalDate.of(2022,1,10), LocalDate.of(2022,1,20),Status.JA)
        val sokndB = Medlemskap("1234", LocalDate.of(2022,1,1), LocalDate.of(2022,1,9),Status.JA)
        println(sokndA)
        println(sokndB)
        Assertions.assertFalse(sokndB.erpåfølgende(sokndA))
